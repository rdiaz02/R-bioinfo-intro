...
\red{FIXME: zz: To be expanded; look at Peng's ``R programming for data
  science'' book. Do we really want to include this?}

\section{Three practical examples}\label{crashex}
