...
<<>>=
## - Compute our statistic (the difference in means here).
##
...
For step 3 we will examine two ways of doing it. Make sure you understand
the differences
<<>>=
## numeric vector, numeric vector -> double (difference of means)
## Given two vectors, create two new vectors as random combination
##  of the set of observations into two groups, and return mean difference
##  of those two groups. [This description could be improved!!]
