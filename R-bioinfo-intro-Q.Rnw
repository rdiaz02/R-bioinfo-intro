...
And what if we want to recover the data and we have a data frame that already contains the frequencies? The following code is something you should be able to understand:
