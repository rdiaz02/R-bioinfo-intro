...
\item Plot y1 as a function of x1. Use points and a line to connect
  consecutive points.
\item Save that plot as a png; call it ``my_pl.png''. Height and width
  should be 340.
\item Save that plot as a pdf; call it ``my_pl.pdf''. height and width
...
\vspace*{20pt}
\paragraph \textbf{Activities} Redo the previous plot but remove the
...
\vpsace*{20pt}
\paragraph \textbf{Activities} Could you add the regression line of
