...
(either clone the repo, if you use or would like to use git, or open
the file as ``Raw'' and then copy and download it \textbf{Do not just
  right-click on the file and download it} ---try it to see what I mean:
you will download an HTML file).
