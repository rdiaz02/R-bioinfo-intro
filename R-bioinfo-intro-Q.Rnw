...
Note, though, that ``Using vectors of more than one element in '\&\&' or '||' will give a warning (as from R 4.2.0), or an error if the environment variable '\_R\_CHECK\_LENGTH\_1\_LOGIC2\_' is set to a true value (this is intended to become the default in future).'' In R-4.4.1 this is now an error: ``Using vectors of more than one element in ‘\&\&’ or ‘||’ will give an error.''
...
Incidentally, this issue comes up from time to time in forums\footnote{\Bulr{https://stackoverflow.com/a/17659731}, \Burl{https://stackoverflow.com/a/14759569}, \Burl{https://stackoverflow.com/a/12064297}, \Burl{https://stackoverflow.com/q/32561050}}.
...
\Bulr{https://adv-r.hadley.nz/environments.html}. But maybe before that do
this
