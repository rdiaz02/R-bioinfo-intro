...
\item Do the Emacs tutorial: start Emacs, and type \texttt{C-h t} (that is: press the Control key and, while holding it, press ``h''; release and press ``t''). This will give you a basic understanding of Emacs keybindings and common terminology. \textbf{Do not skip this}.
...
this is what I use in my scratchpads.
