...
work with R: StatET
(\Burl{https://projects.eclipse.org/projects/science.statet}).   And some Windows users like Tinn-R (\Burl{https://github.com/jcfaria/Tinn-R});
...
This was mentioned above, and some students ask. So I'll anticipate. We have
...
manipulating R's statistical functions output-- plus it created other problems
with nonstandard evaluation.  With regards to the famous pipe, I first liked it
when I saw it (I use in the shell a lot) but then found it hard to debug programs
