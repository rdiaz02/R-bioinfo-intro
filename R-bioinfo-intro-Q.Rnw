...
## The above should be cristal clear. Now for something not intuitive (for
## me) ......

## What if we index a matrix with a matrix with more than 2 columns?
...
## Humm... it seems R uses the entries in m22 as just the position
## in the matrix (as if it were a vector). Let's check
